        ...
        <div class="subheader w-100">
            <div class="row align-items-center">
                ...
                <div class="col-12 col-md-6 text-end">
                    <button v-if="selected.numbers.length && views.loading == false" @click="delNumbers()" class="btn btn-outline-danger">Удалить</button>
...
export default {
    ...
    methods: {
        ...
        delNumbers() {
            ...
            while(this.selected.numbers.length > 0) {
                let chunk = this.selected.numbers.splice(0, chunkSize)
